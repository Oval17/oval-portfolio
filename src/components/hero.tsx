    ...
    <>
      <section className="px-6 py-8">
        <div className="max-w-2xl mx-auto flex items-center gap-6">
          {/* Avatar placeholder — swap src once you have a photo */}
          <div
            className="w-24 h-24 sm:w-28 sm:h-28 rounded-full flex-shrink-0 flex items-center justify-center text-2xl font-bold select-none"
            style={{
