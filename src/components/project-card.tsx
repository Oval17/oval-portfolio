...
export default function ProjectCard({ project }: { project: Project }) {
  return (
    <div
      role="link"
      tabIndex={0}
      onClick={() => window.open(project.liveHref, "_blank", "noopener,noreferrer")}
      onKeyDown={(e) => {
    ...
    >
      ...
      <a
        ...
        className="shrink-0 inline-flex items-center gap-1.5 text-xs font-mono px-2.5 py-1.5 rounded-md transition-opacity hover:opacity-70"
